...
namespace RenameMe.Api.Infrastructure.EfCore.Bases
{
    ...
    public class TopRowsQueryTranslationPostprocessorFactory : IQueryTranslationPostprocessorFactory
    {
        ...
        public TopRowsQueryTranslationPostprocessorFactory(QueryTranslationPostprocessorDependencies dependencies, RelationalQueryTranslationPostprocessorDependencies relationalDependencies)
        {
    ...
    {
        private readonly RelationalQueryTranslationPostprocessorDependencies relationalDependencies;
        public TopRowsQueryTranslationPostprocessor(QueryTranslationPostprocessorDependencies dependencies, RelationalQueryTranslationPostprocessorDependencies relationalDependencies, QueryCompilationContext queryCompilationContext) : base(dependencies, relationalDependencies, queryCompilationContext)
        {
            this.relationalDependencies = relationalDependencies;
        }
